...
DEFINES +=
INCLUDES := $(shell pkg-config --cflags ncursesw icu-uc) -I../../../contrib/zstd/common -I../../../contrib/zstd
LIBS := $(shell pkg-config --libs ncursesw icu-uc) -lpthread
IMAGE := tbrowser

FILTER := \
    $(wildcard ../../../contrib/pdcurses/*)
